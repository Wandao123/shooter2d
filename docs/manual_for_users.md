...
<dl>
    <dt>int ScreenHeight</dt><dd>画面の縦幅を表します。</dd>
    <dt>int ScreenWidth</dt><dd>画面の横幅を表します。</dd>
    <dt>int PlayerHeight</dt><dd>自機のスプライトの縦幅を表します。</dd>
    <dt>int PlayerWidth</dt><dd>自機のスプライトの横幅を表します。</dd>
</dl>
